...
| Order | Module | Status | Validation |
|---:|---|---|---|
...
| 11 | Octopus | Pending | Not started |
| 12 | Consensus engine | Pending | Not started |
| 13 | Variant filtering | Pending | Not started |
| 14 | Annotation | Pending | Not started |
| 15 | ACMG decision support | Pending | Not started |
| 16 | Reporting | Pending | Not started |
| 17 | Integration tests | Pending | Not started |
