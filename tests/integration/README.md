...
`test_alignment.sh` is intentionally a real-runtime test. It builds a small
...
and step-checkpoint reuse. It does not mock scientific executables or accept placeholder BAMs.
